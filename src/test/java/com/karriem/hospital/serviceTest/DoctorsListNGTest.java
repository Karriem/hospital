 ...
 * @author Karriem
 */
public class DoctorsListNGTest {
    
    private static ApplicationContext ctx;
    private DoctorsRepository repo;
    private DoctorsListService service;
    
    public DoctorsListNGTest() {
    }
    ...
    //
     ...
     public void listDoctors() {
         ...
         service = ctx.getBean(DoctorsListService.class);
         ...
         Assert.assertEquals(3, service.listDoctors().size());
     }
